...
Rml::CompiledGeometryHandle FRmlRenderInterfaceD3D11::CompileGeometry(Rml::Span<const Rml::Vertex> Vertices, Rml::Span<const int> Indices)
{
	...
	Geometry->VertexBuffer->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("RmlGeometryVertexBuffer"), "RmlGeometryVertexBuffer");
	...
	Geometry->IndexBuffer->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("RmlGeometryIndexBuffer"), "RmlGeometryIndexBuffer");
...
void FRmlRenderInterfaceD3D11::CreateConstantBuffer()
{
	...
	PerFrameCB->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("RmlPerFrameCB"), "RmlPerFrameCB");
...
void FRmlRenderInterfaceD3D11::CreateWhiteTexture()
{
	...
	if (SUCCEEDED(Device->CreateTexture2D(&TextureDesc, &InitialData, &Texture)))
	{
		...
		Texture->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("RmlWhiteTexture"), "RmlWhiteTexture");
		WhiteTextureSRV->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("RmlWhiteTextureSRV"), "RmlWhiteTextureSRV");
		Texture->Release();
	}
}

...
void FTileCullingVisualizer::Initialize(ID3D11Device* InDevice)
{
	...
	VisCullingCB->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("VisCullingCB"), "VisCullingCB");
	...
	VisBuffer->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("VisBuffer"), "VisBuffer");
	...
	VisStagingBuf->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("VisStagingBuf"), "VisStagingBuf");
...
void FTileBasedLightCulling::Initialize(ID3D11Device* InDevice)
{
	...
	TileCullingCB->SetPrivateData(WKPDID_D3DDebugObjectName, (UINT)strlen("TileCullingCB"), "TileCullingCB");

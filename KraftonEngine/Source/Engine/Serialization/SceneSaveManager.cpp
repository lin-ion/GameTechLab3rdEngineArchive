...
json::JSON FSceneSaveManager::SerializeProperties(UObject* Obj)
{
	...
	TArray<const FProperty*> Descriptors;
	Obj->GetNonTransientProperties(Descriptors);

	for (const FProperty* Prop : Descriptors) {

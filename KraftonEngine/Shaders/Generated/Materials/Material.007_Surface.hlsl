// Generated from C:/Github/Week14/Jungle_Week14_Team4/KraftonEngine/Content/Material/Auto/Material.007.uasset
// Domain: Surface
...
{
    float3 n_1 = float3(0.800000f, 0.024340f, 0.002338f);
    float n_5 = 1.000000f;
    float3 n_7 = float3(0.500000f, 0.500000f, 0.500000f);
    float3 n_3 = float3(0.000000f, 0.000000f, 0.000000f);
    float n_9 = 1.000000f;

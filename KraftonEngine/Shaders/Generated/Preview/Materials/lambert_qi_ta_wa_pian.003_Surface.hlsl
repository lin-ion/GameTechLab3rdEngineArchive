// Generated from C:/Github/Week14/Jungle_Week14_Team4/KraftonEngine/Content/Material/Auto/lambert_qi_ta_wa_pian.003.uasset
// Domain: Surface
...
{
    float3 n_1 = float3(0.300000f, 0.300000f, 0.300000f);
    float4 n_5 = Tex_NormalTexture.Sample(LinearWrapSampler, Input.UV0);
    float4 n_43 = Tex_Diffuse.Sample(LinearWrapSampler, Input.UV0);
    float3 n_19 = float3(0.500000f, 0.500000f, 0.500000f);
    float3 n_15 = float3(0.000000f, 0.000000f, 0.000000f);
    float n_21 = 1.000000f;
    FMaterialResult Result;
    Result.BaseColor = n_1;
    Result.Normal = (n_5).rgb;
    Result.Roughness = (n_43).r;
    Result.Metallic = 0.0f;
    Result.Specular = n_19;
    Result.Emissive = n_15;
    Result.Opacity = n_21;
    return Result;
}
